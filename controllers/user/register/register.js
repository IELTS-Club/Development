...
register.post("/register",async(req,res)=>{
    ...
    if(validation.error){
        ...
        if(validation.error.message=='child "phone" fails because ["phone" length must be at least 11 characters long]'){req.flash("error","شماره شما باید ۱۱ رقم باشد")}
...
<!--[if (IE)]></div><![endif]-->
    ...
    `
    send(email,"تایید ایمیل","تأیید ایمیل",html);
